...
const portfolioData = {
  ...
  // Format: "YYYY-MM-DD"
  config: {
    experienceStartDate: "2019-01-01" // TODO: set to your real start date if not Jan 1
  },

  // ---------------- Identity / nav ----------------
  identity: {
    name: "Alex Rivera",              // shown in nav + footer
    handle: "alex.dev",               // short logo text, e.g. yourname.dev
  },
  ...
  hero: {
    ...
    subtext: "{{yearsInt}} years building native iOS apps with Swift, UIKit, and SwiftUI. For the last 4 months I've been deep in Flutter — shipping my own app, its admin panel, and a companion website with a React + Firebase backend.",
    stats: [
      { label: "iOS experience", value: "{{years}} yrs" },
      { label: "Flutter", value: "4 months" },
  ...
  experience: [
    {
      ...
      description: "Started building iOS apps with Swift and UIKit during my final year university project, then carried that into my first professional iOS role.",
    ...
    },
    {
      ...
      description: "Took ownership of larger app modules end to end — architecture, networking layer, and App Store releases. Started adopting SwiftUI for new screens alongside the existing UIKit codebase.",
    ...
    },
    {
      ...
      description: "Led iOS delivery on a team project, working across UIKit and SwiftUI, mentoring on architecture decisions, and owning releases through to the App Store.",
    ...
    },
    {
      ...
      description: "Spent the last 4 months learning Flutter by building a full product myself: a mobile app, its admin panel, and a companion marketing website backed by Firebase — my first cross-platform build.",
  ...
  skills: [
    {
      ...
      items: ["Swift", "UIKit", "SwiftUI", "Combine", "Core Data", "Auto Layout"]
    },
    {
    ...
    },
    {
      ...
      items: ["Firebase Auth", "Firestore", "Cloud Functions", "Firebase Hosting", "Push notifications"]
    },
    {
      label: "Tooling",
      title: "App lifecycle",
    ...
    },
    {
      ...
      items: ["Code review", "Agile / Scrum", "Cross-functional collaboration", "Mentoring"]
    }
  ],
  ...
  projects: [
    // ---- Company / team projects (iOS, Swift) ----
    {
      ...
      status: "Live",
      description: "Built and maintained key features as part of the iOS team, working across UIKit and SwiftUI in a production codebase shipped to the App Store.", // TODO: real description
    ...
    },
    {
      ...
      title: "App name", // TODO
      status: "Live",
      description: "Contributed to architecture, networking, and release process as part of a cross-functional product team.", // TODO
    ...
    },
    {
      ...
      status: "Maintained",
      description: "Owned a major module end to end, from design handoff through App Store release and post-launch iteration.", // TODO
    ...
    // ---- Personal projects ----
    {
      ...
      status: "Live",
      description: "My first cross-platform build: a Flutter app, a companion admin panel to manage its content/users, and a marketing website — all built solo in 4 months, backed by Firebase.", // TODO — tailor this
    ...
    },
    {
      ...
      status: "Live",
      description: "A personal iOS app built independently with UIKit, from concept through App Store submission.", // TODO
      stack: ["Swift", "UIKit"],
      metrics: [
  ...
  // ---------------- Footer ----------------
  footer: {
    copyright: "© 2026 · Built with intent, not a template.",
    socials: [
      { label: "GitHub", href: "#" },
      { label: "LinkedIn", href: "#" },
